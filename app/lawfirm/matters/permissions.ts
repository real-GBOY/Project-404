...
export const matterPermissions: PermissionDefinition[] = [
  ...
  { action: "update", resource: "matter", description: "Edit matter details and post timeline updates" },
  ...
  { action: "write", resource: "matter_note", description: "Add or edit a matter's internal notes" },
];
