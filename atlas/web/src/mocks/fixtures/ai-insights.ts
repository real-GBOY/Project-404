...
export const DASHBOARD_INSIGHTS: DashboardInsightFixture[] = [
  {
    key: 'velocity', tag: 'Velocity', tagBg: '#E8F4EF', tagFg: '#1E7A5A', confidence: 'confidence 0.94',
  ...
  {
    key: 'conversion', tag: 'Conversion', tagBg: '#EDF1FC', tagFg: '#1B4DB8', confidence: 'confidence 0.89',
  ...
  {
    key: 'decay', tag: 'Risk', tagBg: '#FBEDED', tagFg: '#9A3838', confidence: 'confidence 0.97',
...
export const INSIGHTS_FEED: InsightFeedItemFixture[] = [
  { tag: 'Risk', tagBg: '#FBEDED', tagFg: '#9A3838', title: '23 high-value leads dormant for 5+ days', body: 'Combined pipeline value EGP 148M across 6 agents. Nine sit with agents already above target load.', cta: 'Create follow-up tasks for the assigned agents', confidence: 'confidence 0.97' },
  { tag: 'Velocity', tagBg: '#E8F4EF', tagFg: '#1E7A5A', title: 'Sales velocity up 18.4% month over month', body: 'North Hills and Cedar Residences contribute 71% of the lift. Skyline is flat at 6.2 units per week.', cta: 'Open sales analytics', confidence: 'confidence 0.94' },
  { tag: 'Pricing', tagBg: '#EDF1FC', tagFg: '#1B4DB8', title: 'Building C sells 1.4pp above price list', body: '82% sell-through with minimal discounting. The C floor mix is a candidate for Palm District Building E.', cta: 'Model the C mix for Building E', confidence: 'confidence 0.88' },
  { tag: 'Collections', tagBg: '#FCF3E4', tagFg: '#8A6120', title: 'EGP 14.2M has aged past 90 days', body: '12 accounts, 4 of them above EGP 1M. Skyline carries 32% of total arrears on 18% of contracts.', cta: 'Escalate the 4 largest accounts', confidence: 'confidence 0.96' },
  { tag: 'Inventory', tagBg: '#F1EFEC', tagFg: '#6E6459', title: '86 units have been listed longer than 120 days', body: 'Mostly penthouses in North Hills A and offices in Skyline. Absorption is 1.9% per month against 4.6% portfolio average.', cta: 'Review pricing for aged inventory', confidence: 'confidence 0.91' },
];
