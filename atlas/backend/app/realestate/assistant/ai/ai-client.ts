 ...
 *
 * Ported from `mizan/backend/app/lawfirm/assistant/ai/ai-client.ts` — identical
 * shape, Atlas-scoped symbols. See docs/atlas-assistant.md.
 */
...
export const AI_CLIENT = Symbol("atlas.assistant.aiClient");
